...
export const SECTION_STYLES = {
  note: {
    container: 'mt-lg px-lg py-md bg-white/[3%] rounded-[4px] border-l-2 border-gray-600 text-xs text-slate-400 print:mt-sm print:px-md print:py-sm',
    title: 'text-2xs font-bold text-slate-400 mb-sm print:text-print-xs',
  },
  info: {
    container: 'mt-lg px-lg py-md bg-accent-500/[6%] rounded-[6px] print:mt-sm print:px-md print:py-sm',
    title: 'text-2xs font-bold text-accent-300 mb-sm print:text-print-xs',
  },
  callout: {
    container: 'mt-lg px-lg py-md bg-ai-500/[8%] border border-ai-500/20 rounded-[6px] print:mt-sm print:px-md print:py-sm',
    title: 'text-2xs font-bold text-ai-400 mb-sm print:text-print-xs',
  },
  highlight: {
    container: 'mt-md px-lg py-lg bg-warning-600/[7%] border border-warning-600/40 rounded-[6px] print:mt-sm print:px-md print:py-sm',
    title: 'text-2xs font-bold text-warning-100 mb-sm print:text-print-xs',
  },
  feature: {
    container: 'mt-lg px-lg py-md bg-accent-500/[8%] border border-accent-500/35 rounded-[6px] print:mt-sm print:px-md print:py-sm',
    title: 'text-2xs font-bold text-accent-300 mb-sm print:text-print-xs',
  },
} as const;
