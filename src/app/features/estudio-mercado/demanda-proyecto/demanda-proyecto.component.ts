...
import data from '../../../../../data/data-2.5-demanda-proyecto.json';
...
const SECTION_COLORS: Record<string, CardColor> = {
  'marco-conceptual':         'indigo',
  'escenario-base':           'purple',
  'escenarios-alternativos':  'amber',
  'pagantes-vs-totales':      'cyan',
  'expansion-consolidada':    'emerald',
  'demanda-residual':         'blue',
};
