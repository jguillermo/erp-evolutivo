...
import data from '../../../../../data/data-2.2.1-perfil-consumidor.json';
...
const SECTION_COLORS: Record<string, CardColor> = {
  'identidad-operativa':   'cyan',
  'creencias-dinero':      'amber',
  'creencias-sunat':       'red',
  'creencias-tecnologia':  'blue',
  'creencias-aprendizaje': 'teal',
  'creencias-pares':       'green',
  'creencias-confianza':   'purple',
  'jobs':                  'emerald',
};
